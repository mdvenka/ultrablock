...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/ultrablock-project/gitian.sigs.ltc.git
...
### Build and sign Ultrablock Core for Linux, Windows, and macOS:
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-linux --destination ../gitian.sigs.ltc/ ../ultrablock/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-win-unsigned --destination ../gitian.sigs.ltc/ ../ultrablock/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-osx-unsigned --destination ../gitian.sigs.ltc/ ../ultrablock/contrib/gitian-descriptors/gitian-osx.yml
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys: See `../ultrablock/contrib/gitian-keys/README.md`.

Verify the signatures

    pushd ./gitian-builder
    ./bin/gverify -v -d ../gitian.sigs.ltc/ -r ${VERSION}-linux ../ultrablock/contrib/gitian-descriptors/gitian-linux.yml
    ./bin/gverify -v -d ../gitian.sigs.ltc/ -r ${VERSION}-win-unsigned ../ultrablock/contrib/gitian-descriptors/gitian-win.yml
    ./bin/gverify -v -d ../gitian.sigs.ltc/ -r ${VERSION}-osx-unsigned ../ultrablock/contrib/gitian-descriptors/gitian-osx.yml
    popd
...
Create (and optionally verify) the signed macOS binary:
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-osx-signed --destination ../gitian.sigs.ltc/ ../ultrablock/contrib/gitian-descriptors/gitian-osx-signer.yml
    ./bin/gverify -v -d ../gitian.sigs.ltc/ -r ${VERSION}-osx-signed ../ultrablock/contrib/gitian-descriptors/gitian-osx-signer.yml
...
Create (and optionally verify) the signed Windows binaries:
    ...
    ./bin/gsign --signer "$SIGNER" --release ${VERSION}-win-signed --destination ../gitian.sigs.ltc/ ../ultrablock/contrib/gitian-descriptors/gitian-win-signer.yml
    ./bin/gverify -v -d ../gitian.sigs.ltc/ -r ${VERSION}-win-signed ../ultrablock/contrib/gitian-descriptors/gitian-win-signer.yml
...
space *do not upload these to the ultrablock.org server, nor put them in the torrent*.
