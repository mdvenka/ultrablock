# Support for Output Descriptors in Ultrablock Core

Since Ultrablock Core v0.17, there is support for Output Descriptors in the
...
on Ultrablock's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Ultrablock Core wallets, a convenience function `combo` is
