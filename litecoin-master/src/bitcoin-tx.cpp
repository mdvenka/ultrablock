...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ultrablock-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ultrablock-tx [options] <hex-tx> [commands]  Update hex-encoded ultrablock transaction\n" +
            "or:     ultrablock-tx [options] -create [commands]   Create hex-encoded ultrablock transaction\n" +
            "\n";
