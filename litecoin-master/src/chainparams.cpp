...
public:
    CMainParams() {
        ...
        // vSeeds.emplace_back("seed-a.ultrablock.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.ultrablocktools.com");
        // vSeeds.emplace_back("dnsseed.ultrablockpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.ultrablocktools.com");
        vSeeds.emplace_back("seed-b.ultrablock.loshan.co.uk");
