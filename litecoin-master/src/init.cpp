...
void Shutdown()
{
    ...
    RenameThread("ultrablock-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ultrablock-project/ultrablock>";
    const std::string URL_WEBSITE = "<https://ultrablock.org>";
...
static void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("ultrablock-loadblk");
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the " /* Continued */
                  "current working directory '%s'. This is fragile, because if ultrablock is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if ultrablock is started while in a temporary directory.\n",
