...
"""Verify that starting ultrablock with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ultrablock with -h for help text")
        ...
        self.log.info("Start ultrablock with -version for version information")
        ...
        self.log.info("Start ultrablockd with -fakearg to make sure it does not start")
